        ...
        <div className="lg:col-span-1 space-y-4">
            <div className="bg-white shadow-lg rounded-xl p-6">
                 ...
                 <div className="flex flex-col gap-3">
                     <button onClick={() => handleOpenTransactionModal('expense')} className="w-full text-right flex items-center gap-3 p-3 bg-slate-100 hover:bg-slate-200 rounded-lg transition" title="تسجيل مبالغ مدفوعة لمصاريف تشغيلية">
